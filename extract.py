...
SYSTEM_PROMPT = (
    ...
    "- tasks: EVERY concrete action item mentioned, even when several are packed "
    "into one sentence (empty list if none)\n"
    "- dates: EVERY date, day or time mentioned, none skipped — copy each EXACTLY "
    "as spoken but always written in English (if the transcript says 'vendredi', "
    "write 'Friday'; never change which day it is)\n"
